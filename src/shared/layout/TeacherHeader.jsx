...
import { teacherNavigation, defaultUser } from "@/shared/data/teacherNav.data";
  ...
  return (
    <header className="sticky top-0 z-50 flex items-center justify-between whitespace-nowrap border-b border-solid border-slate-200 bg-white/80 backdrop-blur-md px-10 py-3">
      <div className="flex items-center gap-8">
        {/* Logo */}
        <Link to="/tutor/dashboard" className="flex items-center gap-4 text-slate-900">
      ...
      <div className="flex flex-1 justify-end gap-8">
        ...
        {/* User Avatar */}
        <div
          className="bg-center bg-no-repeat aspect-square bg-cover rounded-full size-10 border border-slate-200 cursor-pointer hover:ring-2 hover:ring-primary/20 transition-all bg-slate-200"
