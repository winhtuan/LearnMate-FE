export default function NeedsAttentionCard({ alerts }) {
  return (
        ...
        {alerts.map((alert) => (
          ...
          >
            <div
              ...
              style={{ backgroundImage: `url("${alert.avatar}")` }}
            />
            <div className="flex flex-col gap-1">
              ...
              <button
                className={`mt-1 text-[10px] font-bold underline uppercase text-left ${
                  alert.severity === 'critical' ? 'text-red-700' : 'text-amber-700'
                }`}
              >
                {alert.action}
