        ...
        <div className="flex items-center justify-between h-16 gap-4">
          ...
          <div className="flex items-center gap-6">
            <nav className="hidden md:flex items-center gap-6 text-sm font-medium text-slate-600">
              <Link to="/tutor/dashboard" className="hover:text-primary transition-colors">Dashboard</Link>
              <Link to="/teacher-ops/students" className="text-primary">Students</Link>
              <Link to="/teacher-ops/live-class" className="hover:text-primary transition-colors">Classes</Link>
            </nav>
