export const tutorDashboardData = {
    ...
    quickActions: [
        { id: 1, label: "View Classes", icon: "add_circle", color: "blue", route: "/tutor/classes" },
        { id: 2, label: "Post Assignment", icon: "assignment", color: "purple", route: "/teacher-assignments/create" },
        { id: 3, label: "View Student", icon: "person_add", color: "orange", route: "/tutor/class/1/students" },
        { id: 4, label: "View Reports", icon: "bar_chart", color: "teal", route: "/tutor/statistics" }
    ],
    activities: [
        {
            id: 1,
