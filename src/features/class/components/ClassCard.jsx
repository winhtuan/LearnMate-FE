...
export default function ClassCard({ classData }) {
  ...
  const handleLeaveClass = () => {
    // Handle leave class logic here
    console.log(`Leaving class: ${title}`);
            ...
            <div className="relative">
              ...
              {isMenuOpen && (
                <>
                  ...
                  ></div>
                  <div className="absolute right-0 top-8 z-20 bg-white rounded-2xl shadow-xl border border-slate-100 py-2 min-w-[180px]">
                    <button
                      onClick={() => {
                        setIsMenuOpen(false);
                        navigate(`/classes/${id}`);
