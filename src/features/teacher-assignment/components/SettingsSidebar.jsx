  ...
  return (
    <aside className="w-full lg:w-80 shrink-0 lg:sticky lg:top-24 space-y-6">
      ...
      <div className="bg-white dark:bg-slate-900 rounded-xl shadow-sm border border-slate-200 dark:border-slate-800 p-6 transition-colors duration-300">
        <h2 className="text-sm font-bold text-slate-900 dark:text-white uppercase tracking-wider mb-6">
          Publishing Settings
        </h2>
        <div className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              <select className="w-full pl-3 pr-10 py-2.5 text-sm bg-slate-50 dark:bg-slate-800 border-slate-200 dark:border-slate-700 rounded-lg focus:ring-primary focus:border-primary text-slate-900 dark:text-white">
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <input
                className="w-full pl-10 pr-3 py-2.5 text-sm bg-slate-50 dark:bg-slate-800 border-slate-200 dark:border-slate-700 rounded-lg focus:ring-primary focus:border-primary text-slate-900 dark:text-white"
                type="datetime-local"
              />
            </div>
          </div>
      ...
      {/* Teacher Tips */}
      <div className="bg-blue-50 dark:bg-blue-900/10 rounded-xl p-4 border border-blue-100 dark:border-blue-900/30 transition-colors duration-300">
